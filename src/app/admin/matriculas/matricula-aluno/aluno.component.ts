...
import { ModalRematriculaComponent } from './modal-rematricula/modal-rematricula.component';
...
export class AlunoComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    // Busca Cep
    if (this.matricula.aluno && this.matricula.aluno.Endereco && this.matricula.aluno.Endereco.cep) {
  ...
  open() {
    const modalRef = this.modalService.open(ModalRematriculaComponent, {centered: true, size: 'lg'});
    modalRef.componentInstance.idUnidade = this.matricula.matricula.idUnidade;
  }
